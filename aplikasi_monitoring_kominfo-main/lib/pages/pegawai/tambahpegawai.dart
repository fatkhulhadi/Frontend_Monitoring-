...
class AddPegawaiModal extends StatefulWidget {
  ...
  @override
  _AddPegawaiModalState createState() => _AddPegawaiModalState();
}

class _AddPegawaiModalState extends State<AddPegawaiModal> {
