    ...
    final filteredData = task.where((program) {
      ...
      switch (selectedFilter) {
        case 'Semua':
          ...
          break;
        case 'Diserahkan':
          matchesFilter = program.pivot != null && program.pivot!.status == 'Diserahkan';
          break;
        case 'Belum Diserahkan':
          matchesFilter = program.pivot == null || program.pivot!.status == 'Belum Diserahkan';
          break;
        case 'Pending':
          matchesFilter = program.pivot != null && program.pivot!.status == 'Pending';
          break;
        case 'Diterima':
          matchesFilter = program.pivot != null && program.pivot!.status == 'Diterima';
          break;
      case 'Terdekat':
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => MelihatLaporanKegiatan(taskId : taskId),
                  ),
                );
              },
            ),
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => EditLaporanKegiatan(taskId : taskId),
                  ),
                );
              },
            ),
