  ...
  onPressed: () async {
    ...
    if (_image == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Harap upload gambar dokumentasi')),
      );
      return;
    }
    ...
    if (_deskripsiController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Harap isi deskripsi kegiatan')),
      );
      return;
    }
    ...
    try {
      await _reportController.createReport(
        ...
        uploadedFilePath1: _image!.path,
        uploadedFilePath2: _documentPath,
      );
      ...
      print('Gambar Path: ${_image!.path}');
      print('Dokumen Path: $_documentPath');
