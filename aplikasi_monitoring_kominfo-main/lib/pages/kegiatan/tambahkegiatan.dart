...
class _TambahKegiatanPageState extends State<TambahKegiatanPage> {
  ...
  String lokasiOption = 'Dalam Kota';
          ...
          children: [
            Radio(
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  // Kosongkan kolom lokasi jika memilih 'Dalam Kota'
                  if (lokasiOption == 'Dalam Kota') {
            ...
            Radio(
              ...
              onChanged: (value) {
                setState(() {
                  lokasiOption = value as String;
                  // Set lokasi ke 'Luar Kota' jika memilih 'Luar Kota'
                  if (lokasiOption == 'Luar Kota') {
      ...
      child: ElevatedButton(
        onPressed: () async {
          ...
          await _taskController.createTask(
            ...
            tanggalKegiatanController.text.trim(),
