...
import 'pages/supervisor/program.dart';
import 'pages/pegawai/profile.dart';

class BottomNavigationSupervisor extends StatefulWidget {
  final int initialIndex;

  BottomNavigationSupervisor({this.initialIndex = 0});

  @override
  _BottomNavigationSupervisorState createState() => _BottomNavigationSupervisorState();
}

class _BottomNavigationSupervisorState extends State<BottomNavigationSupervisor> {
