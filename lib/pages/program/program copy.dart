...
class _ProgramScreenState extends State<ProgramScreen> {
  ...
  void initState() {
    ...
    // _programController.getTotalTask();
    _sectorController.getAllSector();
    _programController.getTotalProgram();
    print(_programController.totalProgram);
  }
        ...
        onPressed: () async {
          final result = await showModalBottomSheet(
            ...
            builder: (BuildContext context) {
              return TambahProgramForm(sectors: _sectorController.sectors);
            },
          );
          if (result == true) {
            _programController.getAllProgram();
              ...
              ListTile(
                ...
                subtitle: Row(
                  children: [
                    ...
                    Container(
                      ...
                      padding:
                          EdgeInsets.all(4.0), // Padding inside the container
                      margin:
                          EdgeInsets.only(right: 4.0), // Margin to the right
                      child: Text(
                ...
                trailing: AnimatedRotation(
                  turns: _isExpandedList[index]
                      ? 0.0
                      : 0.0, // Rotate 360 degrees when expanded
                ...
                onTap: () {
                  setState(() {
                    _isExpandedList[index] =
                        !_isExpandedList[index]; // Toggle the expansion state
                  });
                },
              ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      // New Card for the icon buttons with white background
// New Card for the icon buttons with white background
                      Card(
                        color:
                        ...
                        elevation:
                            0, // Ubah nilai elevation menjadi 0 untuk menghilangkan shadow
                        child: Padding(
                          padding: const EdgeInsets.all(
                              4.0), // Padding inside the card
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [
                              _buildCircularIconButton(Icons.edit, Colors.amber,
                                  () {
  ...
  Widget _buildCircularIconButton(
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: color, width: 2), // Border dengan ukuran 2
      ),
      child: Padding(
        padding: const EdgeInsets.all(0), // Margin antara border dan icon
        child: Container(
          decoration: BoxDecoration(
            color: Colors.white, // Background color of the icon button
            shape: BoxShape.circle, // Bentuk lingkaran
          ),
          child: IconButton(
            icon: Icon(icon, color: color, size: 24), // Ukuran icon
            onPressed: onPressed,
