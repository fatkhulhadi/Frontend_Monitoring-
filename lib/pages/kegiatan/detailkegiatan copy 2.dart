...
//                         DataCell(Text(member.name ?? 'Unknown')),
//                         DataCell(
//                           Container(
//                             width: 40,
//                             height: 40,
...
//  void _showDeleteConfirmationDialog(BuildContext context, TeamModel member) {
//     showDialog(
//       context: context,
//       builder: (BuildContext context) {
//         return AlertDialog(
//           title: Text("Konfirmasi Hapus"),
//           content: Text("Apakah Anda yakin ingin menghapus ${member.name} dari kegiatan ini?"),
//           actions: <Widget>[
//             TextButton(
//               child: Text("Tidak"),
//               onPressed: () {
...
//               onPressed: () async {
//                 try {
//                   await _taskController.deleteTaskMember(
//                     taskId: widget.task.id!,
//                     memberId: member.id!,
//                   );
...
//                     SnackBar(
//                       content: Text('Anggota berhasil dihapus dari kegiatan'),
//                       backgroundColor: Colors.green,
//                     ),
//                   );
//                 } catch (e) {
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     SnackBar(
//                       content: Text('Gagal menghapus anggota: ${e.toString()}'),
